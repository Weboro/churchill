...
const CybersecurityIncident = () => {
  ...
  const handleFileChange = (event) => {
    ...
    if (files) {
      setAttachments([...files]); // Add all selected files
    }
  };
    ...
    try {
      ...
      Object.keys(formState).forEach((key) => {
        if (Array.isArray(formState[key])) {
          // Append array fields properly (incidentType and impacted)
      ...
      if (response.ok) {
        ...
        toastRef.current.show("Email sent successfully!"); // Assuming ToastComponent usage
      } else {
              ...
              >
                <div className="flex items-center gap-1 ">
                  ...
                  <div className="flex flex-col">
                    <div className="whitespace-nowrap">Submit</div>
