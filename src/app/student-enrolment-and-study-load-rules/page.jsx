        ...
        <section className="mb-12">
          <div className="bg-white rounded-lg shadow-lg border-primary-orange p-8">
            ...
            <p className="text-gray-700">
              ...
              to Overseas Students 2018 (Cth) and Churchill Institute’s Course
              Progression and Graduation Policy, CoE extensions (changing the
              course end date to a later date) are only considered based on
              compassionate or compelling circumstances, or when a student can
              show they tried to improve their academic performance by
              completing activities outlined in the LMP.
            </p>
          </div>
        </section>
