  ...
  return (
    <div className="container mx-auto px-5">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        <div className="bg-light-grey hover-shadow transition-all rounded-md row-span-2 flex flex-col justify-between">
          <div className=" flex flex-col px-6 py-5  gap-5">
            ...
            <p>
              ...
              benefits users greatly but presents new challenges in maintaining
              academic integrity. This tool aims to help users understand the
              ethical use of AI in learning and prevent academic misconduct.
            </p>
            <Link
