...
const NewsSection = () => {
  return (
    <div className="container relative mx-auto mb-[48px] rounded-md group ">
      <div className="flex px-5 flex-col md:flex-row bg-[#F3E4E4] relative hover-shadow overflow-hidden rounded-md">
