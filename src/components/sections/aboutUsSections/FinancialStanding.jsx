      ...
      <div className="container mx-auto px-5">
        <main className="max-w-5xl mx-auto px-4 py-12 space-y-12">
          ...
          <section className="bg-white rounded-lg shadow-lg p-6 fade-in">
            ...
            <p className="text-gray-700 leading-relaxed">
              Churchill Institute of Higher Education enrols approximately 499
              international students (Semester 1/2025) at an estimated EFTSL of
              218.31 for this semester.
            </p>
