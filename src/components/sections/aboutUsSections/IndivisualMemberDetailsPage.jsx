...
//   useEffect(() => {
//     try {
// const info = navItems[0]?.Catagories?.find(
//   (item) => item?.slug === "governance-and-leadership;"
// );
...
// // const TeamDetails = ({ image, title, subTitle, description, slug }) => {
// //   return (
// //     <section>
// //       <Image height={300} width={300} src={image} alt={`image for ${title}`} />
