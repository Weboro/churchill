          ...
          <div className="flex flex-col gap-5">
            <div className="flex gap-3 items-center">
              ...
              <p>
                ...
                CIHE Sydney<span className="text-[#FF0000]">*</span>
              </p>
            </div>
            <p>
              privacy policy and to receive communications from CIHE Sydney
              policy and to receive communications from CIHE Sydneypolicy and to
              receive communications from CIHE Sydney policy and to receive
              communications from CIHE Sydney policy and to receive
              communications from CIHE Sydneypolicy and to receive
              communications from CIHE Sydneypolicy and to receive
            </p>
          </div>
        </div>
