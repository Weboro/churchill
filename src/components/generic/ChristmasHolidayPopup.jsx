...
const STORAGE_KEY = "CIHE_holiday_notice_dismissed";
...
export default function ChristmasHolidayPopup() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
      <div className="bg-gray-50 border-border/50 max-h-[85vh] w-full max-w-lg overflow-hidden rounded-2xl border shadow-2xl">
        <div className="border-b px-8 py-6">
          <h2 className="mb-2 text-3xl font-bold">
            Churchill Christmas Holiday Period
          </h2>
        </div>
